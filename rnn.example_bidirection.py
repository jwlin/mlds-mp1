...
test_file = '../dataset/posteriorgram/test2.post'
...
def step(x_t,x_t2,a_tm1,y_tm1,a_tm2,y_tm2):
    ...
    y_t2 = softmax(T.dot(a_t2,Wo) + bo)
    #y_t = T.dot(a_t,Wo) + bo
    return a_t,y_t,a_t2,y_t2
...
[a_seq,y_seq,a_seq2,y_seq2],_ = theano.scan(
    step,
    sequences =[x_seq, x_seq2],
    outputs_info = [ a_0,y_0, a_1,y_1 ],
    truncate_gradient=-1
)
